      ...
      <div class="header-nav">
        <el-form ref="queryForm" v-permission="'system:role:list'" :model="queryParams" :inline="true" label-width="68px">
          ...
          <el-form-item label="所属环境">
            <el-select size="small" v-model="queryParams.is_private" placeholder="请选择">
              <el-option  label="私有服务" :value="true"></el-option>
              <el-option  label="公有服务" :value="false"></el-option>
            </el-select>
          </el-form-item>
      ...
      <el-form ref="form" :model="form" label-width="110px" :rules="rules">
          ...
          <el-col :span="12">
            <el-form-item label="代码仓库" prop="code_registry_id">
              <el-select v-model="form.code_registry_id" placeholder="请选择">
                <el-option v-for="item in codes" :key="item.id" :label="item.name" :value="item.id"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="镜像仓库" prop="image_registry_id">
              <el-select v-model="form.image_registry_id" placeholder="请选择">
                <el-option v-for="item in images" :key="item.id" :label="item.name" :value="item.id"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-form-item label="代码仓库核检" prop="repo">
          <el-row >
            ...
            <el-col :span="10">
              <el-input style="margin-left: 25px;" v-model="form.repo" size="medium" autocomplete="off" placeholder="项目名称" />
            </el-col>
            <el-col :span="4">
              <div style="text-align: right;">
                <el-button type="primary" size="small" v-if="form.owner && form.repo" @click="validateProject">核查</el-button>
              </div>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="运行端口" prop="run_port">
              <el-input-number v-model="form.run_port" :min="80" :max="65545"> </el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="监听端口" prop="listen_port">
              <el-input-number v-model="form.listen_port" :min="80" :max="65545"> </el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="副本数量" prop="replicas">
              <el-input-number v-model="form.replicas" :min="1" :max="20"> </el-input-number>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="探测方式" prop="probe_type">
              <el-select size="small" v-model="form.probe_type" placeholder="请选择">
                <el-option  label="http" value="httpGet"></el-option>
                <el-option  label="commond" value="exec"></el-option>
          ...
          <el-col :span="12">
            <el-form-item label="探测延迟" prop="probe_init_delay">
              <el-input-number v-model="form.probe_init_delay" :min="5" :max="60"> </el-input-number>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    // 获取查询列表 使用异步函数处理
    async getList() {
      let data = await getServiceInfos(this.queryParams);
      this.list = data.list
