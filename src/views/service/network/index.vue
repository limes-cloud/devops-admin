<template>
  <div>
    <el-card class="box-card">
      ...
      <el-table v-loading="loading" v-permission="'service:network:page'" :data="list">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      const data = await getNetworks(this.queryParams)
      this.list = data.list
    ...
    async handleUpdate(row) {
      ...
      const service = await getServices({ id: this.form.id, page: 1, count: 1 })
